...
/// data : {"id":"245","user_id":"62","uneaque_id":null,"purpose":null,"pickup_area":null,"pickup_date":null,"drop_area":null,"pickup_time":null,"area":null,"landmark":null,"pickup_address":"151, Ward 35, Ratna Lok Colony, Indore, Madhya Pradesh 452010, India","drop_address":"M/227, Bairathi Colony, Saifee Nagar, Indore, Madhya Pradesh 452014, India","taxi_type":"Bike","departure_time":null,"departure_date":null,"return_date":null,"flight_number":null,"package":null,"promo_code":null,"distance":null,"amount":"54.99","paid_amount":"64.88","address":null,"transfer":null,"item_status":null,"transaction":"cash","payment_media":null,"km":"6.48832818419953","timetype":null,"assigned_for":"58","is_paid_advance":"0","status":"0","latitude":"22.7468837","longitude":"75.8980128","drop_latitude":"22.7008878","drop_longitude":"75.8590856","booking_type":"Point To Point","accept_reject":"1","created_date":"2023-05-22","username":"","reason":"","surge_amount":"0","gst_amount":"18","base_fare":"","time_amount":"","rate_per_km":"","admin_commision":"","total_time":"","cancel_charge":"","car_categories":"0","otp":"4879","start_time":"00:00:00","end_time":"00:00:00","taxi_id":"","hours":"","booking_time":"00:00:00","shareing_type":"","sharing_user_id":"0","promo_discount":"","payment_status":"","bookings_type":"ride_booking","pickup_floor":null,"drop_floor":null,"category":null,"unit":null,"date_added":"2023-05-22 18:48:53","culculate_gst_amount":"9.90","gst_type":"include","driver_name":"New Driver ","driver_email":"Driver@gmail.com","driver_mobile":"9679649767","driver_image":"https://sodindia.com/uploads/profile_pics/64661a4416d3d.jpg"}

class RideBookedModel {
  RideBookedModel({
      bool? status, 
      String? message, 
      RideData? data,}){
  ...
  RideBookedModel.fromJson(dynamic json) {
    _status = json['status'];
    _message = json['message'];
    _data = json['data'] != null ? RideData.fromJson(json['data']) : null;
  }
  bool? _status;
  String? _message;
  RideData? _data;
RideBookedModel copyWith({  bool? status,
  String? message,
  RideData? data,
}) => RideBookedModel(  status: status ?? _status,
  message: message ?? _message,
  data: data ?? _data,
);
  bool? get status => _status;
  String? get message => _message;
  RideData? get data => _data;
...
/// area : null
/// landmark : null
/// pickup_address : "151, Ward 35, Ratna Lok Colony, Indore, Madhya Pradesh 452010, India"
/// drop_address : "M/227, Bairathi Colony, Saifee Nagar, Indore, Madhya Pradesh 452014, India"
/// taxi_type : "Bike"
/// departure_time : null
/// departure_date : null
/// return_date : null
...
/// drop_latitude : "22.7008878"
/// drop_longitude : "75.8590856"
...
/// category : null
/// unit : null
/// date_added : "2023-05-22 18:48:53"
/// culculate_gst_amount : "9.90"
/// gst_type : "include"
/// driver_name : "New Driver "
/// driver_email : "Driver@gmail.com"
/// driver_mobile : "9679649767"
/// driver_image : "https://sodindia.com/uploads/profile_pics/64661a4416d3d.jpg"
...
class RideData {
  ...
  RideData.fromJson(dynamic json) {
    _id = json['id'];
