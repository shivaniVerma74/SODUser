...
import 'package:ez/screens/view/models/model.dart';
import 'package:ez/screens/view/models/ticket_model.dart';
import 'package:ez/screens/view/models/ticket_type_model.dart';
...
class _CustomerSupportState extends State<CustomerSupport>
  ...
  Future getType() async {
    ...
    var request = http.MultipartRequest(
        'GET', Uri.parse('${baseUrl()}get_ticket_types'));
  ...
  Future getTicket() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${baseUrl()}get_tickets'));
    request.fields.addAll({
      "user_id": '${userId.toString()}',
      "ticket_id": "1",
      "user_type": "user",
  ...
  Future<void> sendRequest() async {
    ...
    try {
      ...
      Response response = await post(edit ? Uri.parse('${baseUrl()}edit_ticket_user') : Uri.parse('${baseUrl()}add_ticket_user'),
        body: data,
        // headers: headers
      )
          .timeout(Duration(seconds: timeOut));
