...
class _ReviewEzState extends State<ReviewService> {
  ...
  Widget ratingbar() {
    return Center(
      child: Container(
        ...
        //   initialRating:
        //       widget.restRatings != null && widget.restRatings!.length > 0
        //           ? double.parse(widget.restRatings!)
        //           : 0.0,
        //   minRating: 0,
  ...
  Widget _poster2(BuildContext context) {
    Widget carousel = widget.images == null
        ? Center(
  ...
  Widget reviewWidget(List<dynamic> model) {
