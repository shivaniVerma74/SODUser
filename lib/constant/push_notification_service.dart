...
Future<void> generateImageNotication(
  ...
  var androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'high_importance_channel', 'big text channel name', 'big text channel description',
...
Future<void> generateSimpleNotication(String title, String msg, String id) async {
  var androidPlatformChannelSpecifics = AndroidNotificationDetails(
